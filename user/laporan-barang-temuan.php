...
<head>
    ...
    <title>Buat Laporan Barang Temuan | iLost</title>
            ...
            <form action="" method="post" enctype="multipart/form-data">
                <div class="space-y-12">
                        ...
                        <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                            ...
                            <div class="sm:col-span-4">
                                ...
                                <p class="mt-1 text-sm leading-6 text-gray-600 dark:text-white">Berikan
                                    rincian/deskripsi tambahan tentang barang temuan</p>
                                <div class="mt-2">
                            ...
                            <div class="sm:col-span-4">
                                <label for="name"
                                    class="block text-xl font-medium leading-6 text-gray-900 dark:text-white">Tanggal
                                    Ditemukan</label>
                                <p class="mt-1 text-sm leading-6 text-gray-600 dark:text-white">Tambahkan tanggal kapan
                                    barang tersebut ditemukan</p>
                                <div class="mt-2">
                            ...
                            <div class="sm:col-span-4">
                                <label for="name"
                                    ...
                                    Ditemukan</label>
                                <p class="mt-1 text-sm leading-6 text-gray-600 dark:text-white">Berikan lokasi ditemukan
                    ...
                    ">
                                ...
                                <input type="hidden" name="kategori_laporan" value="Temuan">
                            </div>
